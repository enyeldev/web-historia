...
export const Pantalla1 = () => {
    return (
        <>
            <div className="w-full h-[560px] flex justify-between overflow-hidden ">
                <div className=" w-full md:w-[50%] max-w-[1000px] px-4 flex flex-col justify-center items-center md:items-start relative gap-4">
                    ...
                    <img src={blob} alt="Blob" className='absolute w-[150px] top-[-1%] left-[90%] z-10 hidden md:block' />
                </div>
